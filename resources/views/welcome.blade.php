...
<div class="container py-4">
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('imagenes/motos.jpg') }}" class="card-img-top" alt="Motos" style="height: 150px; object-fit: cover;">
                <div class="card-body d-flex flex-column text-center">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('imagenes/repuestos.png') }}"
                    class="card-img-top mx-auto d-block"
                    alt="Repuestos"
                    style="max-height: 200px; width: auto; object-fit: contain; padding: 10px;">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('imagenes/preorden.jpg') }}" class="card-img-top" alt="Preórdenes" style="height: 150px; object-fit: cover;">
                <div class="card-body d-flex flex-column text-center">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
                <img src="{{ asset('imagenes/diagnostico.png') }}" class="card-img-top" alt="Diagnóstico" style="height: 150px; object-fit: cover;">
                <div class="card-body d-flex flex-column text-center">
